...
%print(fig11,'Fig_Store\FootCAE_Curve','-depsc','-r600');
...
annotation('arrow',[0.65 0.55],[0.35 0.46]);
annotation('ellipse',[0.59 0.26 0.14 0.09]);
% Partial enlarged drawing
subfig = axes('Position',[0.20 0.38 0.34 0.18]);
set(subfig, 'xlim',[0.17 0.24], 'ylim',[0.0 0.05], 'FontSize',12, 'FontName','Times New Roman');
hold on; box on;
plot(Zr_2W(1,:),Zr_2W(2,:), 'm-','LineWidth',4);
plot(Z_2W_trial_MPC_PID.Z_2W_trial{1}(1,:),Z_2W_trial_MPC_PID.Z_2W_trial{1}(2,:), 'k:','LineWidth',2);
plot(Z_2W_trial_MPC_SMC.Z_2W_trial{1}(1,:),Z_2W_trial_MPC_SMC.Z_2W_trial{1}(2,:), 'r.-','LineWidth',2);
...
plot(Z_2W_trial_MPC_RATSMC.Z_2W_trial{1}(1,:),Z_2W_trial_MPC_RATSMC.Z_2W_trial{1}(2,:), 'b-','LineWidth',2);
hold off;
%print(fig12,'Fig_Store\TrackingComparison_Curve','-depsc','-r600');
...
hold off;
%print(fig13,'Fig_Store\3DView_Curve','-depsc','-r600');
...
zlabel('$Z_{\rm w}$ (m)', 'FontSize',fontSize, 'FontName','Times New Roman', 'Interpreter','latex');
view([0,0,1]);      % Top view
legend('Body-ref','Body-act','Foot1','Foot2','Foot3','Foot4','Foot5','Foot6', 'Position',[0.74,0.61,0.18,0.34]);
hold off;
%print(fig14,'Fig_Store\TopView_Curve','-depsc','-r600');
...
%print(fig15,'Fig_Store\ActualAngles_Curve','-depsc','-r600');
