%% Polyline-shaped Reference Trajectory
%**************************************************************************
...
gait_flag = 4;          % Gait mode of the robot (3 or 4 or 5)
switch gait_flag
...
% PART 1
%**************************************************************************
numStridePer_1 = 8;                                    % Number of stride period during rhythmic movement
...
Ur_1 = [0.08; 0.00; deg2rad(0)] * ones(1,Nrhyth_1);     % Reference control input [Sx; Sy; Sz]
...
% PART 2
%**************************************************************************
numStridePer_2 = 8;                                    % Number of stride period during rhythmic movement
...
Ur_2 = [0.00; 0.08; deg2rad(0)] * ones(1,Nrhyth_2);     % Reference control input [Sx; Sy; Sz]
...
% PART 3
%**************************************************************************
numStridePer_3 = 8;                                    % Number of stride period during rhythmic movement
Tend_rhyth_3 = numSwingPer * Tswing * numStridePer_3;   % End time of rhythmic movement
Nrhyth_3 = Nstride * numStridePer_3;                    % Interpolation points of rhythmic movement
TimeSeq_rhyth_3 = linspace(ts,Tend_rhyth_3, Nrhyth_3);	% Sampling time sequences of rhythmic movement

GammaFoot_horiz_rhyth_3 = kron(ones(1,numStridePer_3), GammaFoot_horiz_strid'); % Foot interpolation in horizontal direction during rhythmic movement
GammaFoot_verti_rhyth_3 = kron(ones(1,numStridePer_3), GammaFoot_verti_strid'); % Foot interpolation in vertical direction during rhythmic movement
GammaBody_rhyth_3 = kron(ones(1,numStridePer_3), GammaBody_strid');             % Body interpolation during rhythmic movement
DGammaBody_rhyth_3 = kron(ones(1,numStridePer_3), DGammaBody_strid');           % Derivative of the body interpolation during rhythmic movement

Ur_3 = [0.08; -0.08; deg2rad(0)] * ones(1,Nrhyth_3);     % Reference control input [Sx; Sy; Sz]
Zr_2B_3 = zeros(3,Nrhyth_3);                            % Reference relative pose of COM w.r.t. the initial body frame [xB_r; yB_r; thB_r]
Zr_2W_3 = zeros(3,Nrhyth_3);                            % Reference absolute pose of COM w.r.t. the world frame [X_r; Y_r; TH_r]
Pr_2B_3 = cell(6,1);                                    % Reference relative position of FOOT w.r.t. the instantaneous body frame
Pr_2W_3 = cell(6,1);                                    % Reference absolute position of FOOT w.r.t. the world frame
q_r_3 = cell(6,1);                                      % Reference joint angles [q1;q2;q3;q4]

Zr_2W_3(:,1) = Zr_2W_2(:,end);
for kr_3 = 1 : Nrhyth_3
    nst = floor((kr_3-1) / Nstride) + 1;                % Number of stride period corresponding to the current moment
    nsw = floor(((kr_3-1) - Nstride * (nst-1)) / Nswing) + 1; % Number of swing period corresponding to the current moment
    %--------------------------------------------------------------------------
    % Relative Pose
    %--------------------------------------------------------------------------
    Zr_2B_3(:,kr_3) = Ur_3(:,kr_3) .* GammaBody_rhyth_3(kr_3);
    for legL = 1 : 6
        [RelFootPose,JointAngle] = FUNCSET.STRIDE(legL,Measure,Alpha,Theta_0,beta_0,phi_0, Ur_3(:,kr_3), Zr_2B_3(:,kr_3), SwiSta, nsw, GammaFoot_horiz_rhyth_3(kr_3), GammaFoot_verti_rhyth_3(kr_3));
        Pr_2B_3{legL}(:,kr_3) = RelFootPose;
        q_r_3{legL}(:,kr_3) = JointAngle;
    end
    %--------------------------------------------------------------------------
    % Absolute Pose
    %--------------------------------------------------------------------------
    Zr_2W_3(3,kr_3) = Zr_2W_3(3,max(1,(nst-1)*Nstride)) + Zr_2B_3(3,kr_3);
    Zr_2W_3(1:2,kr_3) = Zr_2W_3(1:2,max(1,(nst-1)*Nstride)) + rot2(Zr_2W_3(3,max(1,(nst-1)*Nstride))) * Zr_2B_3(1:2,kr_3);
    for legL = 1 : 6
        Pr_2W_3{legL}(1:2,kr_3) = Zr_2W_3(1:2,kr_3) + rot2(Zr_2W_3(3,kr_3)) * Pr_2B_3{legL}(1:2,kr_3);
        Pr_2W_3{legL}(3,kr_3) = Pr_2B_3{legL}(3,kr_3);
    end
end
...
% PART 4
%**************************************************************************
numStridePer_4 = 8;                                    % Number of stride period during rhythmic movement
Tend_rhyth_4 = numSwingPer * Tswing * numStridePer_4;   % End time of rhythmic movement
Nrhyth_4 = Nstride * numStridePer_4;                    % Interpolation points of rhythmic movement
TimeSeq_rhyth_4 = linspace(ts,Tend_rhyth_4, Nrhyth_4);	% Sampling time sequences of rhythmic movement

GammaFoot_horiz_rhyth_4 = kron(ones(1,numStridePer_4), GammaFoot_horiz_strid'); % Foot interpolation in horizontal direction during rhythmic movement
GammaFoot_verti_rhyth_4 = kron(ones(1,numStridePer_4), GammaFoot_verti_strid'); % Foot interpolation in vertical direction during rhythmic movement
GammaBody_rhyth_4 = kron(ones(1,numStridePer_4), GammaBody_strid');             % Body interpolation during rhythmic movement
DGammaBody_rhyth_4 = kron(ones(1,numStridePer_4), DGammaBody_strid');           % Derivative of the body interpolation during rhythmic movement

Ur_4 = [0.08; 0.00; deg2rad(0)] * ones(1,Nrhyth_4);     % Reference control input [Sx; Sy; Sz]
Zr_2B_4 = zeros(3,Nrhyth_4);                            % Reference relative pose of COM w.r.t. the initial body frame [xB_r; yB_r; thB_r]
Zr_2W_4 = zeros(3,Nrhyth_4);                            % Reference absolute pose of COM w.r.t. the world frame [X_r; Y_r; TH_r]
Pr_2B_4 = cell(6,1);                                    % Reference relative position of FOOT w.r.t. the instantaneous body frame
Pr_2W_4 = cell(6,1);                                    % Reference absolute position of FOOT w.r.t. the world frame
q_r_4 = cell(6,1);                                      % Reference joint angles [q1;q2;q3;q4]

Zr_2W_4(:,1) = Zr_2W_3(:,end);
for kr_4 = 1 : Nrhyth_4
    nst = floor((kr_4-1) / Nstride) + 1;                % Number of stride period corresponding to the current moment
    nsw = floor(((kr_4-1) - Nstride * (nst-1)) / Nswing) + 1; % Number of swing period corresponding to the current moment
    %--------------------------------------------------------------------------
    % Relative Pose
    %--------------------------------------------------------------------------
    Zr_2B_4(:,kr_4) = Ur_4(:,kr_4) .* GammaBody_rhyth_4(kr_4);
    for legL = 1 : 6
        [RelFootPose,JointAngle] = FUNCSET.STRIDE(legL,Measure,Alpha,Theta_0,beta_0,phi_0, Ur_4(:,kr_4), Zr_2B_4(:,kr_4), SwiSta, nsw, GammaFoot_horiz_rhyth_4(kr_4), GammaFoot_verti_rhyth_4(kr_4));
        Pr_2B_4{legL}(:,kr_4) = RelFootPose;
        q_r_4{legL}(:,kr_4) = JointAngle;
    end
    %--------------------------------------------------------------------------
    % Absolute Pose
    %--------------------------------------------------------------------------
    Zr_2W_4(3,kr_4) = Zr_2W_4(3,max(1,(nst-1)*Nstride)) + Zr_2B_4(3,kr_4);
    Zr_2W_4(1:2,kr_4) = Zr_2W_4(1:2,max(1,(nst-1)*Nstride)) + rot2(Zr_2W_4(3,max(1,(nst-1)*Nstride))) * Zr_2B_4(1:2,kr_4);
    for legL = 1 : 6
        Pr_2W_4{legL}(1:2,kr_4) = Zr_2W_4(1:2,kr_4) + rot2(Zr_2W_4(3,kr_4)) * Pr_2B_4{legL}(1:2,kr_4);
        Pr_2W_4{legL}(3,kr_4) = Pr_2B_4{legL}(3,kr_4);
    end
end


%% 【Complete reference trajectory】
numStridePer = numStridePer_1 + numStridePer_2 + numStridePer_3 + numStridePer_4;     % Number of stride period during rhythmic movement
Tend_rhyth = Tend_rhyth_1 + Tend_rhyth_2 + Tend_rhyth_3 + Tend_rhyth_4;           % End time of rhythmic movement
Nrhyth = Nrhyth_1 + Nrhyth_2 + Nrhyth_3 + Nrhyth_4;                       % Interpolation points of rhythmic movement
TimeSeq_rhyth = linspace(ts,Tend_rhyth, Nrhyth);    % Sampling time sequences of rhythmic movement
GammaFoot_horiz_rhyth = [GammaFoot_horiz_rhyth_1, GammaFoot_horiz_rhyth_2, GammaFoot_horiz_rhyth_3, GammaFoot_horiz_rhyth_4];	% Foot interpolation in horizontal direction during rhythmic movement
GammaFoot_verti_rhyth = [GammaFoot_verti_rhyth_1, GammaFoot_verti_rhyth_2, GammaFoot_verti_rhyth_3, GammaFoot_verti_rhyth_4]; % Foot interpolation in vertical direction during rhythmic movement
GammaBody_rhyth = [GammaBody_rhyth_1, GammaBody_rhyth_2, GammaBody_rhyth_3, GammaBody_rhyth_4];                   % Body interpolation during rhythmic movement
DGammaBody_rhyth = [DGammaBody_rhyth_1, DGammaBody_rhyth_2, DGammaBody_rhyth_3, DGammaBody_rhyth_4];                % Derivative of the body interpolation during rhythmic movement
Ur = [Ur_1, Ur_2, Ur_3, Ur_4];                                  % Reference control input [Sx; Sy; Sz]
Zr_2B = [Zr_2B_1, Zr_2B_2, Zr_2B_3, Zr_2B_4];                         % Reference relative pose of COM w.r.t. the initial body frame [xB_r; yB_r; thB_r]
Zr_2W = [Zr_2W_1, Zr_2W_2, Zr_2W_3, Zr_2W_4];                         % Reference absolute pose of COM w.r.t. the world frame [X_r; Y_r; TH_r]
...
for legL = 1 : 6
    Pr_2B{legL} = [Pr_2B_1{legL}, Pr_2B_2{legL}, Pr_2B_3{legL}, Pr_2B_4{legL}];
    Pr_2W{legL} = [Pr_2W_1{legL}, Pr_2W_2{legL}, Pr_2W_3{legL}, Pr_2W_4{legL}];
    q_r{legL} = [q_r_1{legL}, q_r_2{legL}, q_r_3{legL}, q_r_4{legL}];
end
...
for legL = 1 : 6
    plot3(Pr_2W{legL}(1,:),Pr_2W{legL}(2,:),Pr_2W{legL}(3,:)+bodyHeight, 'LineWidth',2);
end
